...
class TheThingsNetwork
{
  ...
  public:
    ...
    bool personalize(const byte devAddr[4], const byte nwkSKey[16], const byte appSKey[16], bool reset = true);
    bool join(const byte appEui[8], const byte appKey[16], bool reset = true);
